			...
			if(CommonUtil.isNotEmpty(xzqh)){
				if(xzqh.endsWith("0000") || xzqh.endsWith("00")){
					...
					if(xzqh.endsWith("0000")){
						sql = "from XT_XZQHB where dm like '" + xzqh.substring(0,2) + "%00' and dm<>'" + xzqh + "' order by dm";
					}else{
						sql = "from XT_XZQHB where dm like '" + xzqh.substring(0,4) + "%' and dm<>'" + xzqh + "' order by dm";
					}

...
public class SJ_HJXX_CZRKJBXXB implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	  private String nbsfzid;//内部身份证ID
	  ...
	  private String lxdbid;
	  private String bz;
	  private String jlbz;
	  private String ywnr;
	  private String cjhjywid;
	  private String cchjywid;
	  private String qysj;
	  private String jssj;
	  private String cxbz;
	
	  private String rynbid;//人员内部ID
	  private String ryid;//人员ID
	  private String hhnbid;//户号内部ID
	  private String mlpnbid;//门楼牌内部ID
	  ...
	  private String csdgjdq;//出生地国家地区
	  ...
	  private String jlx_text;
	  private String jwh_text;
	  
	  //跨地市迁移
	  private String qcflag;
	  //迁出地变动范围代码
	  private String qcdbdfw;
	  
	  private String kdqqy_zqz;
	  private String kdqqy_qrdz;
	  private String kdqqy_qyldyy;
	  private String kdqqy_qczxlb;
	  private String kdqqy_qrdqh;
	  
	public String getQcdbdfw() {
		return qcdbdfw;
	}

	public void setQcdbdfw(String qcdbdfw) {
		this.qcdbdfw = qcdbdfw;
	}
	...
	public String getKdqqy_zqz() {
		return kdqqy_zqz;
	}

	public void setKdqqy_zqz(String kdqqy_zqz) {
		this.kdqqy_zqz = kdqqy_zqz;
	}

	public String getKdqqy_qrdz() {
		return kdqqy_qrdz;
	}

	public void setKdqqy_qrdz(String kdqqy_qrdz) {
		this.kdqqy_qrdz = kdqqy_qrdz;
	}
	...
	public String getKdqqy_qczxlb() {
		return kdqqy_qczxlb;
	}

	public void setKdqqy_qczxlb(String kdqqy_qczxlb) {
		this.kdqqy_qczxlb = kdqqy_qczxlb;
	}
	...
	public String getJlx_text() {
		return jlx_text;
	}

	public void setJlx_text(String jlx_text) {
		this.jlx_text = jlx_text;
	}

	public String getJwh_text() {
		return jwh_text;
	}

	public void setJwh_text(String jwh_text) {
		this.jwh_text = jwh_text;
	}
	...
	public String getLxdbid() {
		return lxdbid;
	}

	public void setLxdbid(String lxdbid) {
		this.lxdbid = lxdbid;
	}
	...
	public String getCjhjywid() {
		return cjhjywid;
	}

	public void setCjhjywid(String cjhjywid) {
		this.cjhjywid = cjhjywid;
	}

	public String getCchjywid() {
		return cchjywid;
	}

	public void setCchjywid(String cchjywid) {

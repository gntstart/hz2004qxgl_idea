...
public class FileController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (CommonUtil.isNotEmpty(type)) {
            ...
            if ("xjzp".equals(type)) {
                ...
                ZzjyManagerService uf = (ZzjyManagerService) SpringContainer.getObject("zzjyManagerService");
                byte[] qm = uf.getzzjyZp(yhid, dqbm);
                if ("2".equals(flag)) {
                    qm = uf.getzzjyZw(yhid, dqbm);
                }
    ...
    protected void doPost(HttpServletRequest httpservletrequest,
        ...
        try {
            ...
            if (CommonUtil.isNotEmpty(method) && className.equals("ywtbService")) {
                YwtbService ywtb = (YwtbService) SpringContainer.getObject(className);
                if (method.equals("saveYwtbfj")) {
                    sj = ywtb.saveYwtbfj(metadata, httpservletrequest);
                }
                return;
            }

...
public class PoHJXX_RHFLXXB
  ...
  private String rhfl_ssxq;//人户分离_省市县区
  private String rhfl_jlx;//人户分离_街路巷
  private String rhfl_mlph;//人户分离_门楼牌号
  private String rhfl_mlxz;//人户分离_门楼详址
  private String rhfl_pcs;//人户分离_派出所
  private String rhfl_zrq;//人户分离_责任区
  private String rhfl_xzjd;//人户分离_乡镇街道
  private String rhfl_jcwh;//人户分离_居村委会
  private String slsj;//受理时间
  private String sldw;//受理单位
  private Long slrid;//受理人ID
  private String zxsj;//注销时间
  private String zxdw;//注销单位
  private Long zxrid;//注销人ID

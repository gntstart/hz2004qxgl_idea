...
//							return;
						...
						/**
							执行导出
						 */
						/*var data = fnQueryFs.getForm().getValues();
						Ext.Msg.wait("正在导出，请稍后...");
						Ext.Ajax.request({
							url:'yw/kdqqy.do?method=exportRktj&table=57&PROCEDURE=p_rpt_hjrkjqbdqktj_dj&colLength=22',
							method:'POST', 
							params:data,
	...
	rktjGrid = new Gnt.ux.Rktj57Grid({
    	region:'center',
    	id:'rktjGrid',
    	title: '查询结果信息',
    	height:200,
    	...
    	url:'tj/rktj.do?method=queryRktj&table=57&PROCEDURE=p_rpt_hjrkjqbdqktj&colLength=22'
    });

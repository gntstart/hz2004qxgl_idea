...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/RktjZjjsqkMxStore.js"></script>
    <script type="text/javascript" src="js/RktjZjjsqkMxGrid.js"></script>
    <script type="text/javascript" src="js/ExtExport.js"></script>
    <script type="text/javascript" src="tj/rktjZjjsqkMx.js"></script>
  </body>
</html>

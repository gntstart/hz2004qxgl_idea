...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/RktjBndbdCsMxStore.js"></script>
    <script type="text/javascript" src="js/RktjBndbdCsMxGrid.js"></script>
    <script type="text/javascript" src="js/ExtExport.js"></script>
    <script type="text/javascript" src="tj/rktjBndbdCsMx.js"></script>
  </body>
</html>

...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/RktjBndbdSwMxStore.js"></script>
    <script type="text/javascript" src="js/RktjBndbdSwMxGrid.js"></script>
    <script type="text/javascript" src="js/ExtExport.js"></script>
    <script type="text/javascript" src="tj/rktjBndbdSwMx.js"></script>
  </body>
</html>

...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/RktjStore58.js"></script>
    <script type="text/javascript" src="js/RktjGrid58.js"></script>
    <script type="text/javascript" src="tj/ExportExcel58.js"></script>
    <script type="text/javascript" src="tj/rktj58.js"></script>	
  </body>
</html>

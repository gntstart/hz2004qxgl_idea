...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/RktjMxStore.js"></script>
    <script type="text/javascript" src="js/RktjMxGrid.js"></script>
    <script type="text/javascript" src="js/ExtExport.js"></script>
    <script type="text/javascript" src="tj/rktjMx.js"></script>
  </body>
</html>

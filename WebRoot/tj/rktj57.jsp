...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/RktjStore57.js"></script>
    <script type="text/javascript" src="js/RktjGrid57.js"></script>
    <script type="text/javascript" src="tj/ExportExcel57.js"></script>
    <script type="text/javascript" src="tj/rktj57.js"></script>	
  </body>
</html>

...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/RktjBndbdQcMxStore.js"></script>
    <script type="text/javascript" src="js/RktjBndbdQcMxGrid.js"></script>
    <script type="text/javascript" src="js/ExtExport.js"></script>
    <script type="text/javascript" src="tj/rktjBndbdQcMx.js"></script>
  </body>
</html>

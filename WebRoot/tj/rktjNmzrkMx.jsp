...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="js/RktjNmzrkMxStore.js"></script>
    <script type="text/javascript" src="js/RktjNmzrkMxGrid.js"></script>
    <script type="text/javascript" src="js/ExtExport.js"></script>
    <script type="text/javascript" src="tj/rktjNmzrkMx.js"></script>
  </body>
</html>

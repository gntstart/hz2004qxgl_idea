 ...
 *
 */
Gnt.ux.SelectDzyxqrZqzxxInfo = Ext.extend(Ext.Window, {
    title: '',
    closeAction: 'hide',
    // closable: false,
    resizable: false,
...
//	autoScroll:true,
    show: function () {
        ...
        Gnt.ux.SelectDzyxqrZqzxxInfo.superclass.show.call(this);
    },
    resetData: function () {
    ...
    initComponent: function () {
        ...
        if (!returnTitleText || returnTitleText == "") returnTitleText = "大专院校迁入详情";
...
//	        height: 100,
            ...
            buttons: [
                ...
                //     minWidth: 75,
                //     handler: function () {
                //         var rootWin = this.findParentByType("dzyxqrZqzxx_info");
        ...
        Gnt.ux.SelectDzyxqrZqzxxInfo.superclass.initComponent.call(this);
    }
});
Ext.reg('dzyxqrZqzxx_info', Gnt.ux.SelectDzyxqrZqzxxInfo);
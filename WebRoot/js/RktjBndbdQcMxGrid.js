/**
 * 统计store，必须先加载commFrames.js,RktjBndbdQcStore.js
 */
Gnt.ux.RktjBndbdQcMxGrid = Ext.extend(Ext.grid.GridPanel, {
	title:'人员基本信息',
	height:200,
	stripeRows: true,
	...
	initComponent: function() {
		this.store=new Gnt.store.RktjBndbdQcMxStore({
		...
		Gnt.ux.RktjBndbdQcMxGrid.superclass.initComponent.call(this);
	}
});
Ext.reg('rktj_grid', Gnt.ux.RktjBndbdQcMxGrid);

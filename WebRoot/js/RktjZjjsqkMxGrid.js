/**
 * 统计store，必须先加载commFrames.js,RktjZjjsqkStore.js
 */
Gnt.ux.RktjZjjsqkMxGrid = Ext.extend(Ext.grid.GridPanel, {
	title:'人员基本信息',
	height:200,
	stripeRows: true,
	...
	initComponent: function() {
		this.store=new Gnt.store.RktjZjjsqkMxStore({
		...
		Gnt.ux.RktjZjjsqkMxGrid.superclass.initComponent.call(this);
	}
});
Ext.reg('rktj_grid', Gnt.ux.RktjZjjsqkMxGrid);

 ...
 */
Gnt.store.RktjZjjsqkMxStore = function(c){
	Gnt.store.RktjZjjsqkMxStore.superclass.constructor.call(this, Ext.apply(c, {
			root: 'list',
			id:'rynbid',
...
Ext.extend(Gnt.store.RktjZjjsqkMxStore, Ext.data.JsonStore);

//JavaScriptDocument
  /**
	...
	*
	*@author Animal <extjssupportteam>
	*
	*/
/**
...
Ext.override(Ext.grid.GridPanel,{
	...
	createWorksheet:function(includeHidden){
		// Calculatecelldatatypesandextraclassnameswhichaffect
		// formatting
		var cellType=[];
		var cellTypeClass=[];
		...
		// Generateworksheetheaderdetails.
		var t='<ss:Worksheet ss:Name="'+excelTitle+'">'+
			...
			'<ss:Row ss:Height="38">'+
				'<ss:Cell ss:StyleID="title" ss:MergeAcross="'+(visibleColumnCount-1)+'">'+
					'<ss:Dataxmlns:html="http://www.w3.org/TR/REC-html40" ss:Type="String">'+
					'<html:B>人口统计导出数据</html:B></ss:Data><ss:NamedCell ss:Name="Print_Titles" />'+
				'</ss:Cell>'+
			'</ss:Row>'+
			'<ss:Row ss:AutoFitHeight="1">'+
			headerXml+
			'</ss:Row>';
			// GeneratethedatarowsfromthedataintheStore
			...
			'<x:WorksheetOptions>'+
				'<x:PageSetup>'+
					...
					'<x:Footer x:Data="Page&Pof&N" x:Margin="0.5" />'+

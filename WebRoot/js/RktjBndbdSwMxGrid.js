/**
 * 统计store，必须先加载commFrames.js,RktjBndbdSwStore.js
 */
Gnt.ux.RktjBndbdSwMxGrid = Ext.extend(Ext.grid.GridPanel, {
	title:'人员基本信息',
	height:200,
	stripeRows: true,
	...
	initComponent: function() {
		this.store=new Gnt.store.RktjBndbdSwMxStore({
		...
		Gnt.ux.RktjBndbdSwMxGrid.superclass.initComponent.call(this);
	}
});
Ext.reg('rktj_grid', Gnt.ux.RktjBndbdSwMxGrid);

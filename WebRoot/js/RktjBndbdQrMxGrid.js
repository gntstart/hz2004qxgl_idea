/**
 * 统计store，必须先加载commFrames.js,RktjBndbdQrStore.js
 */
Gnt.ux.RktjBndbdQrMxGrid = Ext.extend(Ext.grid.GridPanel, {
	title:'人员基本信息',
	height:200,
	stripeRows: true,
	...
	initComponent: function() {
		this.store=new Gnt.store.RktjBndbdQrMxStore({
		...
		Gnt.ux.RktjBndbdQrMxGrid.superclass.initComponent.call(this);
	}
});
Ext.reg('rktj_grid', Gnt.ux.RktjBndbdQrMxGrid);

 ...
 */
Gnt.store.ZYqrHjspywStore = function(c){
	Gnt.store.ZYqrHjspywStore.superclass.constructor.call(this, Ext.apply(c, {
			root: 'list',
			id:'spywid',
...
"qyrysqrgx2","qyrysqrgx3","qyrysqrgx4","sfqyz","qyzbh","sfbj","qyrzzssxq","qyrhkdjjg","sfcsjtb"/**/],
			listeners:{
...
Ext.extend(Gnt.store.ZYqrHjspywStore, Ext.data.JsonStore);

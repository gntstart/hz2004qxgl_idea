 ...
 */
Gnt.ux.ZyqrHjspywGrid = Ext.extend(Ext.grid.GridPanel, {
    title: '准迁人员基本信息',
    height: 200,
    stripeRows: true,
    ...
    initComponent: function () {
        this.store = new Gnt.store.ZYqrHjspywStore({
        ...
        Gnt.ux.ZyqrHjspywGrid.superclass.initComponent.call(this);
    }
});
Ext.reg('hjspyw_grid', Gnt.ux.ZyqrHjspywGrid);

 ...
 */
Gnt.ux.YwpmGrid = Ext.extend(Ext.grid.GridPanel, {
	title:'业务排名统计信息',
	height:200,
	stripeRows: true,
	...
	initComponent: function() {
		this.store=new Gnt.store.YwpmStore({
		...
		Gnt.ux.YwpmGrid.superclass.initComponent.call(this);
	}
});
...
Ext.reg('rktj_grid', Gnt.ux.YwpmGrid);

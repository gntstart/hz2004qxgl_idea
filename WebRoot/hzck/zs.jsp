...
<%@ page import="com.gnt.qxgl.common.util.DateHelper"%>
						...
						<table width="95%" height="110" border="0" align="center" cellpadding="0" cellspacing="0" style="font-size:12px; color:#000000;" >
						  <tr>
							<td width="100%" height="24" style="border-bottom:#C0C0C0 solid 1px; border-bottom-style:dashed; font-size:12px;">
								<div align="left">
									<img src="./images/qx.gif" width="15" height="15" align="absmiddle" /> <%= vo.getName() %> <!-- 4区 4县 108窗口  -->
								</div>
							</td>
						  </tr>
						  <tr>
							<td height="24" style="border-bottom:#C0C0C0 solid 1px; border-bottom-style:dashed; font-size:12px;">
								<div align="left">
									<img src="./images/hzdt.gif" width="15" height="15" align="absmiddle">
										 户办大厅:
										<a href="./mx/hzck_mx.jsp?dsdm=<%= vo.getDqbm() %>&yhlx=2&cxlx=0" >
							...
							<td height="24" style="border-bottom:#C0C0C0 solid 1px; border-bottom-style:dashed; font-size:12px;">
								<div align="left">
									<img src="./images/pcs.gif" width="15" height="15" align="absmiddle">
										 派出所:
										<a href="./mx/hzck_mx.jsp?dsdm=<%= vo.getDqbm() %>&yhlx=1&cxlx=1" >
						  ...
						  <tr>
							<td height="24"  style="border-bottom:#C0C0C0 solid 1px; border-bottom-style:dashed; font-size:12px;">
								<div align="left"><img src="./images/calendar.gif" width="15" height="15" align="absmiddle">
									 最新同步时间  <%= DateHelper.formateDate(vo.getGxsj(), "yyyy-MM-dd HH:mm:ss") %> 
								</div>
							</td>
						  </tr>
						</table>

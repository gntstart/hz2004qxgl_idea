  ...
  <body>
   	...
   	<Script Lanaguage="JavaScript">
		...
		var funcs = [
    				...
    				int menucount = 0;
    				String menu = null;
    				/*menu = com.gnt.qxgl.common.BaseUser.getExtToolbarMenus(u.getFuncs(),"用户管理",true,"JGRYGL",p);
    				if(menu!=null){
    				...
    				menu = com.gnt.qxgl.common.BaseUser.getExtToolbarMenus(u.getFuncs(),"人口总览图",true,"RKZLT",p);
    				if(menu!=null){
    					if(menucount>0) out.println(",'-',");
    				...
    				menu = com.gnt.qxgl.common.BaseUser.getExtToolbarMenus(u.getFuncs(),"长三角跨省迁移",true,"YZSYDQC",p);
    				if(menu!=null){
    					if(menucount>0) out.println(",'-',");
    				...
    				menu = com.gnt.qxgl.common.BaseUser.getExtToolbarMenus(u.getFuncs(),"长三角户籍证明",true,"YWTB",p);
    				if(menu!=null){
    					if(menucount>0) out.println(",'-',");
    				...
    				menu = com.gnt.qxgl.common.BaseUser.getExtToolbarMenus(u.getFuncs(),"全国人口普查",true,"QGRKPC",p);
    				if(menu!=null){
    					if(menucount>0) out.println(",'-',");
    				...
    				menu = com.gnt.qxgl.common.BaseUser.getExtToolbarMenus(u.getFuncs(),"长三角户口跨省网上迁移情况",true,"CSJHKKSWSQYQK",p);
    				if(menu!=null){
    					if(menucount>0) out.println(",'-',");

...
//		};
	...
	function drawEchartS(list,xzqhmc){
		...
		option3.title.text= (xzqhmc?xzqhmc:echartsTitleName)+'流入流出饼图';
		...
		option4.title.text= (xzqhmc?xzqhmc:echartsTitleName)+'人口流入';
		...
		option5.title.text= (xzqhmc?xzqhmc:echartsTitleName)+'人口流出';
		...
		option8.title.text= (xzqhmc?xzqhmc:echartsTitleName)+'迁入本省与外省对比饼图';
		...
		option9.title.text= (xzqhmc?xzqhmc:echartsTitleName)+'迁入省份柱状图';

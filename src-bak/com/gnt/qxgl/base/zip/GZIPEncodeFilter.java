    ...
    */
    ...
    public void doFilter ( ServletRequest request, ServletResponse response,
        ...
        if (compressionThreshold == 0) {
            if (debug > 0) {
                System.out.println("doFilter gets called, " +
                		"but compressionTreshold is set to 0 - no compression");
            }
        ...
        if (request instanceof HttpServletRequest) {
            ...
            if ("false".equals(s)) {
                if (debug > 0) {
                    System.out.println("got parameter gzip=false " +
                    		"--> don't compress, just chain filter");
                }
                chain.doFilter(request, response);
                return;
            }

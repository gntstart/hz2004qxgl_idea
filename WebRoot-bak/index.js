...
Ext.onReady(function(){
	...
	new Ext.Viewport({
        ...
        items:[{
        	 ...
        	 border:false,
        	 layout:'fit',
        	 title:'<table border=0 with="100%" ><TR with="100%" background="images/top-bg.gif"><TD with="100%" background="images/top-bg.gif"><img src="images/top.gif" height=45 style="vertical-align:bottom "></img></td></tr></table>',
        	// iconCls:'icon-home',

...
<table width="100%" height="129"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td>
	    <table width="100%" height="80" border="0" cellpadding="0" cellspacing="0" background="./images/banner_bg.gif" class="banner-table">
	      <tr>
	        ...
	        <td width="28%" valign="top" background="./images/banner_bg.gif" class="banner-table-right">
		        <table width="270" height="80" border="0" align="right" cellpadding="0" cellspacing="0">
		        </table>
	        </td>
	      </tr>
	    </table>

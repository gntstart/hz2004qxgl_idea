...
function alai_tree_check()
{
	...
	alai_tree.prototype.addChkNode=function(toNode,text,ico,exeCategory,exeArg,checked,va,ischeck,key)
	{
		var newNode=this.add(toNode,"last",text,key,ico,exeCategory,exeArg)
		
		if(ischeck=="1"){ 
    		var chkBox=document.createElement('<input type="Checkbox" value="'+va+'">') 
    		var tree=this
